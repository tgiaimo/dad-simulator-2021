...
public class badBatNegTerminal : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider other)
    {
        if (other.gameObject.name == tool.name)
        {
            ...
            GameObject.Find("battery/neg").GetComponent<clippedCheck>().clipped = true;
        }
    }
    ...
    void OnTriggerExit(Collider other)
    {
        if (other.gameObject.name == tool.name)
        {
            ...
            GameObject.Find("battery/neg").GetComponent<clippedCheck>().clipped = false;
        }
    }
}
