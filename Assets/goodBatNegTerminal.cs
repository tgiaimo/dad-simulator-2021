...
public class goodBatNegTerminal : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider other)
    {
        if (other.gameObject.name == tool.name)
        {
            ...
            GameObject.Find("goodBattery/neg").GetComponent<clippedCheck>().clipped = true;
        }
    }
    ...
    void OnTriggerExit(Collider other)
    {
        if (other.gameObject.name == tool.name)
        {
            ...
            GameObject.Find("goodBattery/neg").GetComponent<clippedCheck>().clipped = false;
        }
    }
}
