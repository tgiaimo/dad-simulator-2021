...
namespace ECE
{
  ...
  public class EasyColliderWindow : EditorWindow
  {
    ...
    private void DrawDocumentationTip()
    {
      ...
      if (GUILayout.Button("Be sure to check out the Quick Start Guide in the <color=blue>documentation.</color>", tipStyle))
      {
