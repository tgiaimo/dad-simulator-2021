...
public class goodBatPosTerminal : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider other)
    {
        if (other.gameObject.name == tool.name)
        {
            ...
            GameObject.Find("goodBattery/red").GetComponent<clippedCheck>().clipped = true;
        }
    }
    ...
    void OnTriggerExit(Collider other)
    {
        if (other.gameObject.name == tool.name)
        {
            ...
            GameObject.Find("goodBattery/red").GetComponent<clippedCheck>().clipped = false;
        }
    }
}
